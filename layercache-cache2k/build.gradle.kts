...
dependencies {
    ...
    implementation("org.cache2k:cache2k-api:1.4.0.Final")
    compileOnly("org.cache2k:cache2k-all:1.4.0.Final")

    testImplementation(project(":testutils"))
    testImplementation("org.cache2k:cache2k-all:1.4.0.Final")
